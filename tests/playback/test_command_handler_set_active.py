...
*this* renderer is the one the app is actually driving right now — the
foundation for Speaker.is_active, which Sonos group-departure handling
uses to decide whether a device leaving a group should be stopped (see
app.py's _on_sonos_room_members_departed and its module docstring note on
"active").
"""
